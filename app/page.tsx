...
import { brand, variants } from "@/content/homepage";
      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        ...
        <div className="mt-16 max-w-3xl">
          ...
          <p className="mt-5 text-sm text-white/50">
            Choose one direction (or a hybrid) and it becomes the design system for the rest of the
            build. Nothing here is connected to a backend yet.
          </p>
        </div>
